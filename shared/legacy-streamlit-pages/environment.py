...
def environment_tab():    
    ...
    with col2:
        ...
        # New profile creation with text input
        col1, col2 = st.columns([3, 1])
        with col1:
            new_profile_name = st.text_input("New Profile Name", key="new_profile_name", placeholder="Enter profile name")
        with col2:
            create_profile_button = st.button("Create Profile", key="create_profile_btn")
        
        # Handle profile creation
        if create_profile_button and new_profile_name:
